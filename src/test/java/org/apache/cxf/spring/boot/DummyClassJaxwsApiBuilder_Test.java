...
import org.apache.cxf.spring.boot.utils.DummyClassJaxrsApiBuilder;
...
public class DummyClassJaxwsApiBuilder_Test {
	...
	public void testM() throws Exception{
		 ...
		 * 
		 */
		Class<?> FirstCaseClass = new DummyClassJaxrsApiBuilder("FirstCaseV2").output(".//target//asmsupport-test-generated")
