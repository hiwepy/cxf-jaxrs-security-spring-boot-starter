 ...
 * the License.
 */
package org.apache.cxf.spring.boot.jaxrs.endpoint.ctweb;
...
public class RestParam<T> {
	...
	public RestParam(Class<T> type, String name,boolean header) {
		this.type = type;
		this.name = name;
		this.header = header;
	}
	
	public RestParam(Class<T> type, String name,Mode mode) {
		this.type = type;
		this.name = name;
		this.mode = mode;
	}
	
	public RestParam(Class<T> type, String name,Mode mode, boolean header) {
		this.type = type;
		this.name = name;
		this.mode = mode;
		this.header = header;
	...
	public RestParam(Class<T> type, String name, String partName, String targetNamespace, Mode mode,
			boolean header) {
		this.type = type;
		this.name = name;
